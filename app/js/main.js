$(function () {
  ...
  $('.product-tabs__top-item').on('click', function (e) {
    //отмена дефолтного события при клике на кнопку
    e.preventDefault();
